...
csvwrite('daitonglvbo.csv',mm1_highpass');
hold on;
plot(a1,mm1);
csvwrite('yuanxinhao.csv',mm1');
...
csvwrite('hilbert.csv',mm1_highpass_outliers_hilbert');
hold on;
plot(a1,signal);
hold on;
title('希尔伯特求包络');
...
plot(a1,(nn1(30000:b)-0.43)/(max((nn1(30000:b)-0.43))));%极板归一化
csvwrite('guiyihuajiban.csv',(nn1(30000:b)-0.43)/(max((nn1(30000:b)-0.43)))');
hold on;
plot(a1,mm1_highpass_outliers_hilbert_lowpass(30000:b)/max(mm1_highpass_outliers_hilbert_lowpass(30000:b)));
csvwrite('guiyihuachangmo.csv',mm1_highpass_outliers_hilbert_lowpass(30000:b)/max(mm1_highpass_outliers_hilbert_lowpass(30000:b))');
hold on;
title('归一化比较');
xlabel('时间/s');
ylabel('幅度/V');
