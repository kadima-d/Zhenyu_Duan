...
%% 贝塞尔滤波器设计
%[b,a] = besself(10,0.5,'low');%阶数，截止频率
%[num,den] = bilinear(b,a,0.5);

%% 閿佺浉鏀惧ぇ
out1=(2.6212767171*2*filter(zuixiaoercheng3,(data.*s1))).*(2.6212767171*2*filter(zuixiaoercheng3,(data.*s1)));%婊ゆ尝鍚庣殑涓?矾杈撳嚭
out2=(2.6212767171*2*filter(zuixiaoercheng3,(data.*s2))).*(2.6212767171*2*filter(zuixiaoercheng3,(data.*s2)));%婊ゆ尝鍚庣殑浜岃矾杈撳嚭
